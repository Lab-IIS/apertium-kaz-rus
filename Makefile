...
pkgdatadir = $(datadir)/apertium-kaz-rus
pkgincludedir = $(includedir)/apertium-kaz-rus
pkglibdir = $(libdir)/apertium-kaz-rus
pkglibexecdir = $(libexecdir)/apertium-kaz-rus
...
am__installdirs = "$(DESTDIR)$(apertium_kaz_rusdir)"
DATA = $(apertium_kaz_rus_DATA) $(noinst_DATA)
...
ACLOCAL = ${SHELL} /home/aida/apertium-testing/apertium-kaz-rus/missing aclocal-1.15
AMTAR = $${TAR-tar}
...
APERTIUM_RUS_CFLAGS = 
APERTIUM_RUS_LIBS = 
AP_LIB1 = /home/aida/apertium-testing/apertium-kaz
AP_LIB2 = /home/aida/apertium-testing/apertium-rus
AP_SRC1 = /home/aida/apertium-testing/apertium-kaz
AP_SRC2 = /home/aida/apertium-testing/apertium-rus
AP_SUBDIRS =  /home/aida/apertium-testing/apertium-kaz /home/aida/apertium-testing/apertium-rus
AUTOCONF = ${SHELL} /home/aida/apertium-testing/apertium-kaz-rus/missing autoconf
AUTOHEADER = ${SHELL} /home/aida/apertium-testing/apertium-kaz-rus/missing autoheader
AUTOMAKE = ${SHELL} /home/aida/apertium-testing/apertium-kaz-rus/missing automake-1.15
AWK = gawk
CGCOMP = /usr/bin/cg-comp
CGPROC = /usr/bin/cg-proc
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"apertium-kaz-rus\" -DPACKAGE_TARNAME=\"apertium-kaz-rus\" -DPACKAGE_VERSION=\"0.2.0\" -DPACKAGE_STRING=\"apertium-kaz-rus\ 0.2.0\" -DPACKAGE_BUGREPORT=\"spectre360@users.sourceforge.net\" -DPACKAGE_URL=\"\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
GZCAT = no
...
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/aida/apertium-testing/apertium-kaz-rus/missing makeinfo
MKDIR_P = /bin/mkdir -p
PACKAGE = apertium-kaz-rus
PACKAGE_BUGREPORT = spectre360@users.sourceforge.net
PACKAGE_NAME = apertium-kaz-rus
PACKAGE_STRING = apertium-kaz-rus 0.2.0
PACKAGE_TARNAME = apertium-kaz-rus
PACKAGE_URL = 
...
VERSION = 0.2.0
ZCAT = zcat
abs_builddir = /home/aida/apertium-testing/apertium-kaz-rus
abs_srcdir = /home/aida/apertium-testing/apertium-kaz-rus
abs_top_builddir = /home/aida/apertium-testing/apertium-kaz-rus
abs_top_srcdir = /home/aida/apertium-testing/apertium-kaz-rus
am__leading_dot = .
...
install_sh = ${SHELL} /home/aida/apertium-testing/apertium-kaz-rus/install-sh
...
###############################################################################
###############################################################################
apertium_kaz_rusdir = $(prefix)/share/apertium/$(BASENAME)/

# Files which should be installed to $(prefix)/share/apertium/$(BASENAME)/:
apertium_kaz_rus_DATA = $(TARGETS_COMMON) \
	$(BASENAME).$(PREFIX1).t1x \
	$(BASENAME).$(PREFIX1).t2x \
	$(BASENAME).$(PREFIX1).t3x 


# MLF 20141127 we don't have probabilities in kaz for the time being
#                    $(PREFIX1).prob
#
...
$(am__aclocal_m4_deps):
install-apertium_kaz_rusDATA: $(apertium_kaz_rus_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_kaz_rus_DATA)'; test -n "$(apertium_kaz_rusdir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_kaz_rusdir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_kaz_rusdir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_kaz_rusdir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_kaz_rusdir)" || exit $$?; \
	done

uninstall-apertium_kaz_rusDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_kaz_rus_DATA)'; test -n "$(apertium_kaz_rusdir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_kaz_rusdir)'; $(am__uninstall_files_from_dir)
tags TAGS:
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_kaz_rusdir)"; do \
...
install-data-am: install-apertium_kaz_rusDATA install-data-local
...
uninstall-am: uninstall-apertium_kaz_rusDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	install install-am install-apertium_kaz_rusDATA install-data \
...
### MLF 20141127 : we don't have kaz probabilities for the time being
###
